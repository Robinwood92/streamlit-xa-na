    ...
    try:
        ...
        async with async_playwright() as p:
            ...
            context = await browser.new_context(
                ...
                device_scale_factor=3,   # Ảnh sắc nét 3x
            ...
            # Chờ bản đồ (Leaflet map) xuất hiện trên DOM
            for _ in range(20):
            ...
            zoom_js = f"""() => {{
                try {{
                    ...
                    if (map) {{
                        // Dịch chuyển tâm bản đồ về 19N 105E và zoom
